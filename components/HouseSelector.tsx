  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        style={{
          borderColor: HOUSE_THEMES[selectedHouse].colors.primary,
          boxShadow: `0 0 12px ${HOUSE_THEMES[selectedHouse].colors.primary}20`,
        }}
      >
      ...
      {isOpen && (
        <div
          ...
          style={{
            borderColor: HOUSE_THEMES[selectedHouse].colors.primary,
            boxShadow: `0 8px 32px ${HOUSE_THEMES[selectedHouse].colors.primary}35`,
          }}
        >
